...
/**
 * Creates a data source from the gradle resource file.
 */
class GradleResourcesSource(private val filer: Filer) {

    /**
     * Convert the gradle resource file to a [Set] of [GradleResourcesEntry].
     */
    fun resourceFileAsList(): Set<GradleResourcesEntry> =
